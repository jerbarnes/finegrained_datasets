...
if __name__ == "__main__":
    ...
    train = [l.strip() for l in open("datasplit/new/filelist_train0").readlines()]
    dev = [l.strip() for l in open("datasplit/new/filelist_dev").readlines()]
    test = [l.strip() for l in open("datasplit/new/filelist_test0").readlines()]
