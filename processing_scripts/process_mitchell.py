...
if __name__ == "__main__":
    ...
    os.makedirs(os.path.join("../processed", "mitchell"), exist_ok=True)
    with open(os.path.join("../processed", "mitchell", "train.json"), "w") as out:
            json.dump(train, out)
    with open(os.path.join("../processed", "mitchell", "dev.json"), "w") as out:
            json.dump(dev, out)
    with open(os.path.join("../processed", "mitchell", "test.json"), "w") as out:
            json.dump(test, out)
